<template>
  <section class="max-w-3xl mx-auto glass-card p-6 text-sm leading-6 text-zinc-200">
    <h1 class="text-white text-2xl font-semibold mb-4">Datenschutzerklärung</h1>
    ...
    <p>Der Quellcode dieser Webseite ist auf <a href="https://github.com/Cedric-CJ/AboutMe" target="_blank" rel="noreferrer">GitHub</a> verfügbar. Dies ermöglicht Transparenz und Mitwirkung der Community.</p>
