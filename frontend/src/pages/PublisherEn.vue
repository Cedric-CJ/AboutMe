<template>
  <section class="max-w-3xl mx-auto glass-card p-6 text-sm leading-6 text-zinc-200">
    ...
    <p>
      Unless otherwise indicated, the content (texts, images, graphics, styles) is protected by copyright. Copying or use –
      including excerpts – is only permitted with prior approval. Trademarks and trade names mentioned are subject to the
      rights of their respective owners.
    </p>

    <h2 class="text-white font-medium mt-6 mb-2">Disclaimer</h2>
    <p>
      The information provided has been compiled with care. No guarantee is made for timeliness, accuracy, completeness or
      quality. Liability claims are excluded unless intent or gross negligence is proven. The operator reserves the right
      to change or remove content without notice.
    </p>

    <h2 class="text-white font-medium mt-6 mb-2">References and Links</h2>
    <p>
      For external pages to which references are made, the respective operators are solely responsible. At the time of
      linking, no illegal content was recognizable.
    </p>
