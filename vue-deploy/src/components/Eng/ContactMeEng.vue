...
<template>
  <div class="contact-page">
    ...
    <div class="cards" @mousemove="handleMouseMove">
      ...
      <a href="https://github.com/Cedric-CJ" target="_blank" class="card" rel="noopener">
        <div class="card-content">
          <img :src="isDarkMode ? githubIconDark : githubIconLight" alt="GitHub Icon" class="icon"/>
          <span>GitHub</span>
        </div>
      </a>
      <a href="https://www.linkedin.com/in/cedric-arnhold-853a122a0" target="_blank" class="card" rel="noopener">
        <div class="card-content">
          <img :src="isDarkMode ? linkedinIconDark : linkedinIconLight" alt="LinkedIn Icon" class="icon"/>
          <span>LinkedIn</span>
        </div>
      </a>
      <a href="https://discord.com/users/456140165094572054" target="_blank" class="card" rel="noopener">
        <div class="card-content">
  ...
  methods: {
    openEmail() {
      window.location.href =
          'mailto:cedric.jon.arnhold+AboutMeAdministration@gmail.com';
    },
