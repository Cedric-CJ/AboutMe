    ...
    <div class="cards" @mousemove="handleMouseMove">
      ...
      <div class="card" @click="openEmail">
        <div class="card-content">
          <img
              :src="isDarkMode ? emailIconDark : emailIconLight"
              alt="E-Mail Icon"
              class="icon"
          />
          <span>E-Mail</span>
      ...
      <!-- GitHub Card -->
      <a
          href="https://github.com/Cedric-CJ"
          target="_blank"
          class="card"
          rel="noopener"
      >
      ...
      <!-- LinkedIn Card -->
      <a
          href="https://www.linkedin.com/in/cedric-arnhold-853a122a0"
          target="_blank"
          class="card"
          rel="noopener"
      >
      ...
      <!-- Discord Card -->
      <a
          href="https://discord.com/users/456140165094572054"
          target="_blank"
          class="card"
          rel="noopener"
      >
